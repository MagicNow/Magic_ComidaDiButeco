...
define('DB_NAME', 'comidadibuteco');

/** MySQL database username */
define('DB_USER', 'comidadibuteco');
...
define('WP_HOME','http://comidadibuteco.magictech.co/');
define('WP_SITEURL','http://comidadibuteco.magictech.co/');
